...
class ProductCard {
    ...
    init(imageName:String, title:String, subtitle:String, originalprice:Double, newprice:Double, image:UIImage, information:String) {
        ImageName = imageName
        Title = title
        Subtitle = subtitle
